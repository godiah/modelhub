            ...
            <div class="space-y-6">
                @foreach ($engagements as $engagement)
                    ...
                    <div x-data="{ open: false }"
                                                            ...
                                                            <div class="space-y-2">
                                                                ...
                                                                <div x-data="{
                                                                    ...
                                                                    <div @dragover.prevent="dragOver = true"
                                                                        ...
                                                                        <input type="file"
                                                                            name="submission_files[]" multiple
                                                                    ...
                                                                    <div x-show="files.length > 0" class="mt-3">
                                                                        <p
                                                                            class="text-xs text-neutral-600 font-main mb-2">
                                                    ...
                                                    <div x-show="expanded" x-collapse
                                                        ...
                                                        <div class="mb-3 flex items-center">
                                                            ...
                                                            @if ($deliverable->approved_at)
                                                                <div
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        class="h-3 w-3 text-green-600 mr-1"
                                                                        fill="none" viewBox="0 0 24 24"
                                                                        stroke="currentColor">
                                                                        <path stroke-linecap="round"
                                                                            stroke-linejoin="round" stroke-width="2"
                                                        ...
                                                        @if ($deliverable->submission_files && count($deliverable->submission_files) > 0)
                                                            <div>
                                                                ...
                                                                <div
                                                                    class="ml-6 grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                                    @foreach ($deliverable->submission_files as $file)
                                                                        <a href="{{ Storage::url($file['path']) }}"
                                                                            target="_blank"
                                    ...
                                    <x-modal name="resubmit-deliverable-{{ $deliverable->id }}" :show="false"
                                        ...
                                        <div class="p-8 font-main">
                                            ...
                                            <form
                                                ...
                                                @if ($deliverable->rejected_at && ($deliverable->submission_files || $deliverable->submission_notes))
                                                    <div
                                                        class="p-4 bg-neutral-100 rounded-md border border-neutral-200 mb-6">
                                                        <div class="flex items-center mb-3">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <div class="p-8">
                                                    ...
                                                    <div class="text-center mb-6">
                                                        <div
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="h-16 w-16" viewBox="0 0 24 24"
                                                                fill="none">
                                        ...
                                        <div x-data="{ feedback: '' }">
                                            <x-modal name="reject-deliverable-{{ $deliverable->id }}"
                                                ...
                                                <div class="p-8">
                                                    ...
                                                    <div class="text-center mb-6">
                                                        <div
                                                            class="flex items-center justify-center text-accent mb-4">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="h-16 w-16" viewBox="0 0 24 24"
                                                                fill="none">
                                                                <circle cx="12" cy="12" r="10"
                                                    ...
                                                    <form method="POST"
                                                        ...
                                                        <div class="mb-6">
                                                            <label for="reject-feedback-{{ $deliverable->id }}"
                                                                class="block text-sm font-medium text-neutral-700 mb-2">
                                                                Feedback <span
                                                                    class="text-accent font-medium">*</span>
                                                            </label>
                                                            <div class="relative">
                        ...
                        <!-- Review Modal -->
                        <div x-data="{ open: false, rating: 0, reviewText: '', tags: [], isPublic: true }" x-on:open-review-modal.window="open = true"
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-300"
                                ...
                                <div class="bg-white rounded-2xl shadow-xl w-full max-w-md mx-auto overflow-hidden"
                                    ...
                                    <div class="p-6">
                                        <form id="reviewForm"
                                            action="{{ route('engagements.review', $engagement) }}"
                                            method="POST">
                                            @csrf
