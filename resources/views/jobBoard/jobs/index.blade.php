<x-app-layout>
    <section class="font-main text-neutral-800 bg-white">
        <!-- Tab Navigation -->
        <div class="bg-neutral-50 border-b border-neutral-200 sticky top-0 z-20">
            <div class="container mx-auto px-4">
                <div class="flex justify-end md:justify-end space-x-4 max-w-7xl mx-auto">
                    <!-- Post a Job -->
                    <button id="post-job-btn"
                        class="flex items-center gap-2 py-4 px-6 font-medium border-b-2 border-secondary text-secondary"
                    ...
                    <button id="find-job-btn"
                        class="flex items-center gap-2 py-4 px-6 font-medium border-b-2 border-transparent text-neutral-600 hover:text-secondary"
