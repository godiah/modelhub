...
<div>
    ...
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden max-w-7xl w-full flex">
        ...
        <x-auth-illustration-panel
            description="Discover and post 3D modeling jobs, connect with top-tier freelance architects, and access premium models to bring your architectural visions to life." />
        ...
        <div class="w-full lg:w-1/2 p-8 lg:p-8">
            <div class=" mx-auto">
                ...
                <div class="text-center mb-8">
                    @if ($showTwoFactorForm)
                        <h1 class="text-2xl font-bold text-neutral-900 font-tertiary tracking-wider">
                            {{ __('Two-Factor Authentication') }}</h1>
                ...
                @if ($showTwoFactorForm)
                    <form class="mt-8 space-y-6 font-main" wire:submit="verifyTwoFactorCode">
                        <div>
                            ...
                            <input wire:model="verification_code" id="verification_code" name="verification_code"
                                ...
                                class="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-center text-lg tracking-widest">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex space-x-3">
                                <button type="button" wire:click="resendTwoFactorCode"
